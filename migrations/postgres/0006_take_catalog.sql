-- PostgreSQL equivalent of 0006_take_catalog.sql.
UPDATE "products" SET
...
--> statement-breakpoint
UPDATE "products"
SET "is_active" = 0, "is_featured" = 0, "updated_at" = to_char(CURRENT_TIMESTAMP AT TIME ZONE 'UTC', 'YYYY-MM-DD HH24:MI:SS')
WHERE "id" IN ('prod_jogurt_1l', 'prod_sir_500g');
--> statement-breakpoint
UPDATE "bundles" SET "is_active" = 0, "updated_at" = to_char(CURRENT_TIMESTAMP AT TIME ZONE 'UTC', 'YYYY-MM-DD HH24:MI:SS');
--> statement-breakpoint
UPDATE "promo_codes" SET "is_active" = 0, "updated_at" = to_char(CURRENT_TIMESTAMP AT TIME ZONE 'UTC', 'YYYY-MM-DD HH24:MI:SS') WHERE "id" = 'promo_demo_welcome';
--> statement-breakpoint

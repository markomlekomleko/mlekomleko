-- PostgreSQL equivalent of 0004_volatile_galactus.sql.
CREATE TABLE "fiscal_receipts" (
	...
	"requested_at" text DEFAULT (to_char(CURRENT_TIMESTAMP AT TIME ZONE 'UTC', 'YYYY-MM-DD HH24:MI:SS')) NOT NULL,
	"issued_at" text,
...
ALTER TABLE "fiscal_receipts" ADD FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON UPDATE no action ON DELETE no action;

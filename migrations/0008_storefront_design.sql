...
UPDATE products SET image_url = '/images/demo/kravlje-mleko.webp', image_alt = 'Ilustracija kravljeg mleka u povratnoj staklenoj flaši', updated_at = CURRENT_TIMESTAMP
WHERE id = 'prod_kravlje_1l' AND image_url = 'https://storage.googleapis.com/takeapp/media/cm52rz909000003mhagpjf52k.png';
--> statement-breakpoint
UPDATE products SET image_url = '/images/demo/kozje-mleko.webp', image_alt = 'Ilustracija kozjeg mleka u povratnoj staklenoj flaši', updated_at = CURRENT_TIMESTAMP
WHERE id = 'prod_kozje_1l' AND image_url = 'https://storage.googleapis.com/takeapp/media/cm52vt3e6000a03jq3nsw8bzc.png';
--> statement-breakpoint
UPDATE settings SET value_json = '"Domaće kravlje i kozje mleko u povratnim staklenim flašama. Dostavljamo na vašu adresu."', updated_at = CURRENT_TIMESTAMP
...
--> statement-breakpoint
UPDATE settings SET value_json = '"Količina i ritam po vašoj meri"', updated_at = CURRENT_TIMESTAMP
WHERE key = 'trustItemTwo' AND value_json = '"Povratne staklene flaše"';
--> statement-breakpoint
UPDATE settings SET value_json = '"Jednokratno ili redovno"', updated_at = CURRENT_TIMESTAMP
WHERE key = 'trustItemThree' AND value_json = '"Tvrdnje o kvalitetu objavljujemo uz dokumentaciju"';
--> statement-breakpoint
UPDATE products SET short_description = 'Domaće kozje mleko u povratnoj staklenoj flaši. Za vaš svakodnevni ritual.', updated_at = CURRENT_TIMESTAMP
...
--> statement-breakpoint
UPDATE products SET description = 'Punomasno sirovo kravlje mleko sa domaćih farmi, u povratnim staklenim flašama. Izaberite količinu po dostavi i poručite jednokratno ili odaberite nedeljni ili dvonedeljni ritam. Pri narednoj dostavi preuzimamo vaše čiste flaše i donosimo pune.', updated_at = CURRENT_TIMESTAMP
...
--> statement-breakpoint
UPDATE products SET description = 'Domaće kozje mleko u povratnim staklenim flašama. Izaberite količinu po dostavi i poručite jednokratno ili odaberite nedeljni ili dvonedeljni ritam. Pri narednoj dostavi preuzimamo vaše čiste flaše i donosimo pune.', updated_at = CURRENT_TIMESTAMP

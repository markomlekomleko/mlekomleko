...
--> statement-breakpoint
ALTER TABLE `products` ADD `is_featured` integer DEFAULT false NOT NULL;
--> statement-breakpoint
ALTER TABLE `products` ADD `allow_subscription` integer DEFAULT true NOT NULL;
--> statement-breakpoint
ALTER TABLE `products` ADD `is_demo` integer DEFAULT false NOT NULL;
--> statement-breakpoint

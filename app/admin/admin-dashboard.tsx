...
export function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const refreshVisible = async () => {
      ...
      if (document.visibilityState !== "visible" || busy || loading || editing || running) return;
      running = true;
  ...
  return (
    <div className="admin-app">
      ...
      <section className="admin-main">
        ...
        {activeTab === "porudzbine" ? <OrdersPanel request={adminFetch} version={ordersVersion} busy={busy} onSave={saveOrder} onExport={downloadOrderExport} /> : null}
